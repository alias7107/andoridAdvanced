...
class SearchableQuoteListViewHolder constructor(
    ...
    override fun navigate(view: View, itemData:Item) {
        view.findNavController().navigate(SearchableQuotesListFragmentDirections.actionSearchableQuotesListFragmentToQuoteDetailFragment2(itemData.id))
    }
